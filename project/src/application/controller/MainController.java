...
public class MainController implements Initializable {
    ...
    private void deleteProject(String id) {
        ...
        ObservableList<String> tickets = dbController.getTickets(id);
        
        dbController.deleteTicketsOfProject(id);
        dbController.deleteById(id, "projectTable");
        // Refresh the project list after deletion
        refreshProjectList();
        
        // delete comments of tickets
        for (String ticket : tickets) {
        	dbController.deleteCommentsOfTicket(getIdFromString(ticket));
        }
